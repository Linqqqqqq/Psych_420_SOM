---
title: "A Computational Exploration of Self-Organizing Maps"
author: "Lin Qiu, Mahrukh Khan, Jake Douglas Wood, Nicole Barkan"
date: April 22, 2026
format:
  html:
    theme: cosmo
  ...
  pdf:
    ...
    include-in-header:
      text: |
        \shorttitle{SOM Exploration}
        \affiliation{University of Waterloo\\ Department of Psychology \\ PSYCH 420: Computational Neuroscience\\ Dr. Britt Anderson}
    mainfont: "Times New Roman"
    fontsize: 12pt
    linestretch: 2
---
...
![](/images/figure_1_final_iteration.png)
\noindent\textit{Note.} Input values were normalized within a range of 0–1.
:::
...
::: {.content-visible when-format="pdf"}
![](/images/figure_2_final_iteration.png)
\noindent\textit{Note.} In the U-Matrix, darker colours represent larger distances between neighbouring nodes, while lighter colours indicate nodes close together in the input space.
:::
